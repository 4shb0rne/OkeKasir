  ...
  <main class="form-login position-absolute top-50 start-50 translate-middle">
    <form>
      ...
      <div class="mb-3">
        ...
        <input type="email" class="form-control" id="InputEmail" placeholder="sherlyphangestu@example.com">
      </div>
      <div class="mb-3">
    ...
    <small class="d-block text-center mt-3">Don't have an account? <a href="/signup" style="color:rgb(42, 42, 42); font-weight:bold">Sign up here</a></small>
  </main>
</body>
</html>
